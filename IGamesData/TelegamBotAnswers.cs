...
enter 'Cancel' to cancel this operation";
        ...
        => "Here are all the genres I've already known. Please enter 'Show' to show their";
...
Slug: {2}
Url : {3}"
, character.name, character.id, character.slug, character.url);
        }
